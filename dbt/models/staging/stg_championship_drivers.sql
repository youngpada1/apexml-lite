...
renamed as (
    select
        ...
        s.raw_data:driver_number::integer     as driver_number,
    ...
    where s.raw_data:driver_number is not null
      and s.raw_data:session_key is not null
    qualify row_number() over (
        partition by s.raw_data:session_key::integer, s.raw_data:driver_number::integer
